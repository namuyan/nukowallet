...
tx_notFound_4               : 'Please use the dropdown in the top-right & select a different Nuko node and check again.',
...
tx_FoundOnChain_3           : '**If you do not see any errors, your transaction was successfully sent.** Your NUKO or Tokens are where you sent them. If you cannot see this NUKO or Tokens credited in your other wallet / exchange account, and it has been 24+ hours since you sent, please [contact that service] and Send them the *link* to your transaction and ask them, nicely, to look into your situation.',
/* Gen Wallet Updates */
GEN_Help_1                  : 'Use your',
...
GEN_Help_12                 : 'Use it to unlock your wallet via NukoWallet (or Mist, Gnekonium, Parity and other wallet clients.) ',
...
GAS_LIMIT_Desc              : 'Gas limit is the amount of gas to send with your TX. `TX fee` = gas price * gas limit & is paid to miners for including your TX in a block. Increasing this number will not get your TX mined faster. Sending NUKO = `21000`. Sending Tokens = ~`200000`.',
...
TXFEE_Desc                  : 'The TX Fee is paid to miners for including your TX in a block. Is is the `gas limit` * `gas price`. [You can convert GWEI -> NUKO here]',
...
NAV_SendEther               : 'Send Nuko & Tokens ',
...
/* General */
x_Access                    : 'Access ',
x_AddessDesc                : 'Your Address can also be known as you `Account #` or your `Public Key`. It is what you share with people so they can send you Nuko or Tokens. Find the colorful address icon. Make sure it matches your paper wallet & whenever you enter your address somewhere.',
...
sidebar_donation            : 'NukoWallet is a free, open-source service dedicated to your privacy and security. The more donations we receive, the more time we spend creating new features, listening to your feedback, and giving you what you want. Would you like to Help us? ',
...
ADD_Ledger_2                : 'Open the Nekonium application (or a contract application) ',
...
ADD_Ledger_0a               : 'Re-open NukoWallet on a secure (SSL) connection ',
ADD_Ledger_0b               : 'Re-open NukoWallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/) ',
...
ADD_Warning_1               : 'You can add any account to "watch" on the wallets tab without uploading a private key. This does ** not ** mean you have access to this wallet, nor can you transfer Nuko from it. ',
...
MYWAL_Content_3             : 'If you want to use this wallet with your NukoWallet CX in the future, you will need to manually re-add it using the private key/JSON and password. ',
...
/* full sentence reads "You are about to send "10 NUKO" to address "0x1234". Are you sure you want to do this? " */
...
SENDModal_Content_4         : 'NOTE: If you encounter an error, you most likely need to add nuko to your account to cover the gas cost of sending tokens. Gas is paid in ether. ',
...
NODE_Warning                : 'Your node must be HTTPS in order to connect to it via NukoWallet.com. You can [download the NukoWallet repo & run it locally](https://github.com/kvhnuke/etherwallet/releases/latest) to connect to any node',
NODE_Name                   : 'Node Name',
NODE_Port                   : 'Node Port',
...
SWAP_order_CTA              : "Please send ", // Please send 1 NUKO...
SWAP_unlock                 : "Unlock your wallet to send NUKO or Tokens directly from this page. ",
...
/* View Wallet Details */
VIEWWALLET_Subtitle         : 'This allows you to download different versions of private keys and re-print your paper wallet. You may want to do this in order to [import your account into Gnekonium/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). If you want to check your balance, we recommend using a blockchain explorer like [explorer.nekonium.org](http://explorer.nekonium.org/). ',
...
HELP_2a_Desc_2              : 'Save the address. You can keep it to yourself or share it with others. That way, others can transfer nuko to you. ',
...
HELP_3_Desc_8               : 'If you are planning on holding a large amount of nuko, we recommend that send a small amount of ether from new wallet before depositing a large amount. Send 0.001 ether to your new wallet, access that wallet, send that 0.001 ether to another address, and ensure everything works smoothly. ',
